                ...
                <Col md={12} sm={12} xs={24} style={colStyle}>
                  <Box>
                    ...
                    <InputGroup compact style={{ marginBottom: '15px' }}>
                      ...
                      <Select defaultValue="nill" style={{ width: '80%' }} name="company_name" onChange={this.handle_change_company_name}>
                        {
                    ...
                    <InputGroup compact style={{ marginBottom: '15px' }}>
                      ...
                      <Select defaultValue="nill" style={{ width: '80%' }} name="truck_number" onChange={this.handle_change_truck_number}>
                        {
                    ...
                    <InputGroup compact style={{ marginBottom: '15px' }}>
                      ...
                      <Select defaultValue="40"  style={{ width: '80%' }} name="package_size" onChange={this.handle_change_package_size}>
                        {
                    ...
                    <InputGroup compact style={{ marginBottom: '15px' }}>
                      ...
                      <Select defaultValue="nill" style={{ width: '80%' }} name="city_name" onChange={this.handle_change_city_from}>
                        {
                    ...
                    <InputGroup compact style={{ marginBottom: '15px' }}>
                      ...
                      <Select defaultValue="nill" style={{ width: '80%' }} name="city_name" onChange={this.handle_change_city_to}>
                        {
                            this.state.CityDetail.map(function(value, index){
                                return <Option value={value.url} >{value.city_name}</Option>;
                            })
                    ...
                    <InputGroup compact style={{ marginBottom: '15px' }}>
                      ...
                      <Select defaultValue="nill" style={{ width: '80%' }} name="order_type" onChange={this.handle_change_order_type}>
                        {
