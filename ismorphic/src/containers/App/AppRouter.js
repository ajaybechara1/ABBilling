    ...
    return (
      <Switch>
        ...
        <Route
          exact
          path={`${url}/newOrder`}
          component={asyncComponent(() => import('../ABBilling/NewOrder'))}
        />

        <Route
          exact
          path={`${url}/addDetails`}
          component={asyncComponent(() => import('../ABBilling/AddDetails'))}
        />

        <Route
          exact
          path={`${url}/generateBill`}
          component={asyncComponent(() => import('../ABBilling/GenerateBill'))}
        />
