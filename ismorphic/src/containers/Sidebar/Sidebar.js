        ...
        >
          ...
          >
            ...
            >
              ...
              <Menu.Item key="new_order">
                <Link to={`${url}/newOrder`}>
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-grid" />
                    <span className="nav-text">
                      <IntlMessages id="sidebar.newOrder" />
                    </span>
                  </span>
                </Link>
              </Menu.Item>
              ...
              <Menu.Item key="addDetails">
                <Link to={`${url}/addDetails`}>
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-grid" />
                    <span className="nav-text">
                      <IntlMessages id="sidebar.addDetails" />
                    </span>
                  </span>
                </Link>
              </Menu.Item>
              ...
              <Menu.Item key="generateBill">
                <Link to={`${url}/generateBill`}>
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-grid" />
                    <span className="nav-text">
                      <IntlMessages id="sidebar.generateBill" />
                    </span>
                  </span>
                </Link>
              </Menu.Item>
